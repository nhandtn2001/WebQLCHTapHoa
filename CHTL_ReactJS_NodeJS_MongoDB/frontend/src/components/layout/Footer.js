            ...
            <div className="row">
              <div className="col-lg-5 col-md-6 col-12">
                ...
                <div className="single-footer about">
                  ...
                  <p className="text">Website bán hàng trực tuyến của HUTECH Store, hỗ trợ 24/7 cùng nhiều ưu đẫi hấp dẫn. Luôn luôn cập nhật mới nhiều sản phẩm.</p>
              ...
              <div className="col-lg-3 col-md-6 col-12">
                ...
                <div className="single-footer social">
                  ...
                  <div className="contact">
                    <ul>
                      <li>475 Điện Biên Phủ, Phường 25, Quận Bình Thạnh</li>
                      <li>Nhóm LNN</li>
